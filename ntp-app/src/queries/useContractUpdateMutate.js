...
const useContractUpdateMutate = (contractId, callbackFn) => {
  ...
  return useMutation({
    mutationFn: (data) => {
      ...
      return request(URLs.CONTRACTS.UPDATE(contractId), {
        verb: 'put',
        params: requestBody
      });
    },
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: [QUERY_KEY.CONTRACT_DETAIL, contractId] });
      callbackFn && callbackFn();
    },
  });
};

export default useContractUpdateMutate; 